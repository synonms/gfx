...
bool    ImGui_ImplOpenGL3_Init(const char* glsl_version)
{
    ...
    std::cout << "IMGUI GLSL version " << g_GlslVersionString << std::endl;
    ...
    std::cout << "IMGUI GL Loader " << gl_loader << std::endl;
...
bool    ImGui_ImplOpenGL3_CreateDeviceObjects()
{
    ...
    std::cout << "IMGUI vertex shader: " << std::endl;
    std::cout << vertex_shader << std::endl;
    std::cout << "IMGUI fragment shader: " << std::endl;

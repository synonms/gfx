    ...
    namespace gfx
    {
        namespace transforms
        {
            ...
            public:
                ...
                Matrix2x2(const geometry::Vector2<float>& xAxis, const geometry::Vector2<float>& yAxis)
                    : xAxis(xAxis)
                    , yAxis(yAxis)
                {
                }

                geometry::Vector2<float> xAxis;
                geometry::Vector2<float> yAxis;
            ...
            public:
                ...
                geometry::Vector2<float> Transform(const geometry::Vector2<float>& input) const
                {

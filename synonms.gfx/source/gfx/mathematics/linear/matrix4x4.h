        ...
        namespace mathematics
        {
            namespace linear
            {
                ...
                public:
                    ...
                    static Matrix4x4 CreateFromRotationAboutAxis(float angleInRadians, const Vector3<float>& axis)
                    {
                        float cos_theta = MathsHelper::Cosine(angleInRadians);
                        float sin_theta = MathsHelper::Sine(angleInRadians);
                    ...
                    static Matrix4x4 CreateFromRotationAxes(const Vector3<float>& xAxis, const Vector3<float>& yAxis, const Vector3<float>& zAxis)
                    {
                        Matrix4x4 result;
                    ...
                    static Matrix4x4 CreateFromScale(const Vector3<float>& scale)
                    {
                        Matrix4x4 result;
                    ...
                    static Matrix4x4 CreateFromTranslation(const Vector3<float>& translation)
                    {
